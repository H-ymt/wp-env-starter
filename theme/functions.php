...
function vite_get_asset_url($asset)
{
  ...
  if (file_exists($manifest)) {
    ...
    if (isset($manifest_content["js/main.js"]["css"][0])) {
      return get_theme_file_uri("/dist/" . $manifest_content["js/main.js"]["css"][0]);
    }
...
function theme_enqueue_assets()
{
  ...
  wp_enqueue_style("theme-style", vite_get_asset_url("scss/style.scss"), [], null);
  wp_enqueue_script("theme-script", vite_get_asset_url("js/main.js"), [], null, true);
}
